...
pub const COMPLETE_PROPERTY_TAG_PATH: &str = "resources/test/complete_property_tag.sav";
...
pub const PALWORLD_PATHS: [&str; 2] = [PALWORLD_ZLIB_PATH, PALWORLD_ZLIB_TWICE_PATH];
