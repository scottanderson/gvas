        ...
        properties: TaggedProperties::from([
            ...
            (
                ...
                TaggedProperty {
                    ...
                    has_binary_or_native_serialize: false,
                    has_property_extensions: false,
                    property: FProperty::from(FArrayProperty::TaggedStruct {
            ...
            (
                ...
                TaggedProperty {
                    ...
                    has_binary_or_native_serialize: false,
                    has_property_extensions: false,
                    property: FProperty::from(FArrayProperty::Int(TArray::from([
                        FIntProperty(12),
                        FIntProperty(12),
                        FIntProperty(12),
                        FIntProperty(12),
            ...
            (
                ...
                TaggedProperty {
                    ...
                    has_binary_or_native_serialize: false,
                    has_property_extensions: false,
                    property: FProperty::from(FArrayProperty::Str(TArray::from([
