...
pub(crate) fn expected() -> USaveGame {
    USaveGame {
        ...
        properties: TaggedProperties::from([
            (
                FString::from("u8_test"),
                TaggedProperty {
                    array_index: 0,
                    has_binary_or_native_serialize: false,
                    has_property_extensions: false,
                    property: FProperty::Byte(FByteProperty::Byte(129)),
                    property_guid: FGuid::default(),
                },
            ),
            (
                FString::from("i8_test"),
                TaggedProperty {
                    array_index: 0,
                    has_binary_or_native_serialize: false,
                    has_property_extensions: false,
                    property: FProperty::Int8(FInt8Property(-123)),
                    property_guid: FGuid::default(),
                },
            ),
            (
                FString::from("ushort_test"),
                TaggedProperty {
                    array_index: 0,
                    has_binary_or_native_serialize: false,
                    has_property_extensions: false,
                    property: FProperty::UInt16(FUInt16Property(65530)),
                    property_guid: FGuid::default(),
                },
            ),
            (
                FString::from("short_test"),
                TaggedProperty {
                    array_index: 0,
                    has_binary_or_native_serialize: false,
                    has_property_extensions: false,
                    property: FProperty::Int16(FInt16Property(-32764)),
                    property_guid: FGuid::default(),
                },
            ),
            (
                FString::from("uint32_test"),
                TaggedProperty {
                    array_index: 0,
                    has_binary_or_native_serialize: false,
                    has_property_extensions: false,
                    property: FProperty::UInt32(FUInt32Property(4294967294)),
                    property_guid: FGuid::default(),
                },
            ),
            (
                FString::from("int32_test"),
                TaggedProperty {
                    array_index: 0,
                    has_binary_or_native_serialize: false,
                    has_property_extensions: false,
                    property: FProperty::Int(FIntProperty(-2147483647)),
                    property_guid: FGuid::default(),
                },
            ),
            (
                FString::from("ulong_test"),
                TaggedProperty {
                    array_index: 0,
                    has_binary_or_native_serialize: false,
                    has_property_extensions: false,
                    property: FProperty::UInt64(FUInt64Property(18446744073709551614)),
                    property_guid: FGuid::default(),
                },
            ),
            (
                FString::from("long_test"),
                TaggedProperty {
                    array_index: 0,
                    has_binary_or_native_serialize: false,
                    has_property_extensions: false,
                    property: FProperty::Int64(FInt64Property(-9223372036854775807)),
                    property_guid: FGuid::default(),
                },
            ),
            (
                FString::from("f_property"),
                TaggedProperty {
                    array_index: 0,
                    has_binary_or_native_serialize: false,
                    has_property_extensions: false,
                    property: FProperty::Float(FFloatProperty(3.14159)),
                    property_guid: FGuid::default(),
                },
            ),
            (
                FString::from("d_property"),
                TaggedProperty {
                    array_index: 0,
                    has_binary_or_native_serialize: false,
                    has_property_extensions: false,
                    property: FProperty::Double(FDoubleProperty(3.14159265358979)),
                    property_guid: FGuid::default(),
                },
            ),
            (
                FString::from("str_property"),
                TaggedProperty {
                    array_index: 0,
                    has_binary_or_native_serialize: false,
                    has_property_extensions: false,
                    property: FProperty::Str(FStrProperty(FString::from("Hello world"))),
                    property_guid: FGuid::default(),
                },
            ),
            (
                FString::from("struct_property"),
                TaggedProperty {
                    array_index: 0,
                    has_binary_or_native_serialize: false,
                    has_property_extensions: false,
                    property: FProperty::Struct(FStructProperty::Custom(
                        FString::from("CustomStruct"),
                        FString(None),
                        FGuid::default(),
                        TaggedProperties::from([(
                            FString::from("test_field"),
                            TaggedProperty {
                                array_index: 0,
                                has_binary_or_native_serialize: false,
                                has_property_extensions: false,
                                property: FProperty::UInt64(FUInt64Property(12345)),
                                property_guid: FGuid::default(),
                            },
                        )]),
                    )),
            ...
            (
                FString::from("date_time_property"),
                TaggedProperty {
                    array_index: 0,
                    has_binary_or_native_serialize: false,
                    has_property_extensions: false,
                    property: FProperty::Struct(FStructProperty::DateTime(FDateTime {
            ...
            (
                FString::from("array_of_structs"),
                TaggedProperty {
                    array_index: 0,
                    has_binary_or_native_serialize: false,
                    has_property_extensions: false,
                    property: FProperty::Array(FArrayProperty::TaggedStruct {
                            ...
                            FStructProperty::Custom(
                                ...
                                TaggedProperties::from([(
                                    ...
                                    TaggedProperty {
                                        ...
                                        has_binary_or_native_serialize: false,
                                        has_property_extensions: false,
                                        property: FProperty::UInt64(FUInt64Property(10)),
                                        property_guid: FGuid::default(),
                                    },
                                )]),
                            ),
            ...
            (
                FString::from("array_of_ints"),
                TaggedProperty {
                    array_index: 0,
                    has_binary_or_native_serialize: false,
                    has_property_extensions: false,
                    property: FProperty::Array(FArrayProperty::Int(TArray::from([
                        FIntProperty(12),
                        FIntProperty(12),
                        FIntProperty(12),
                        FIntProperty(12),
            ...
            (
                FString::from("array_of_strings"),
                TaggedProperty {
                    array_index: 0,
                    has_binary_or_native_serialize: false,
                    has_property_extensions: false,
                    property: FProperty::Array(FArrayProperty::Str(TArray::from([
